...
-- Insert staff account with password "password123" - already hashed with bcrypt
-- Hash for "password123": $2a$10$JK4Nh31Z8JVCnGTrUTP3YeQm3HpB3fGJqKbc7YCk4ZRBs7p3rZD.u

-- Sample data from INSERTIONS.sql goes here
-- (Sample data provided is quite extensive - you can add it from the INSERTIONS.sql file)

-- Populate Authors, Publishers, Genres, LibraryBranches, Books, etc.
